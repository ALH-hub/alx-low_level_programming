...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	check_elf(header->e_file);
	printf("ELF Header:\n");
	print_magic(header->e_file);
	print_class(header->e_file);
	print_data(header->e_file);
	print_version(header->e_file);
	print_osabi(header->e_file);
	print_abi(header->e_file);
	print_type(header->e_type, header->e_file);
	print_entry(header->e_entry, header->e_file);
